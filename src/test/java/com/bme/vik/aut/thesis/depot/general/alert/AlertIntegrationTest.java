...
public class AlertIntegrationTest {
    ...
    void shouldEmitExpiredProductEventAndChangeProductStatus() {
        ...
        for (Product product : inventoryProducts) {
            if (product.getDescription().equals("Long Expired Product")) {
                assertEquals(ExpiryStatus.LONGEXPIRED, product.getExpiryStatus());
            } else if (product.getDescription().equals("Expired Product")) {
                assertEquals(ExpiryStatus.EXPIRED, product.getExpiryStatus());
            } else if (product.getDescription().equals("Soon to Expire Product")) {
                assertEquals(ExpiryStatus.SOONTOEXPIRE, product.getExpiryStatus());
            } else if (product.getDescription().equals("Not Expired Product")) {
                assertEquals(ExpiryStatus.NOTEXPIRED, product.getExpiryStatus());
            }
        }
    }
}
